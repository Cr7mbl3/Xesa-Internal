...
void C_BaseEntity::SetInterpolationFlag(int flag)
{
...
bool& C_BaseEntity::ClientSideAnimation()
{
...
{
	float serverTime = static_cast<float>(m_nTickBase()) * g_GlobalVars->interval_per_tick;
	...
	if (weapon->m_flNextPrimaryAttack() > serverTime)
		return false;
