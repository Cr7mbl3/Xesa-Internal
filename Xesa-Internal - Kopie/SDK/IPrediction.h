...
public:
	bool InPrediction()
	{
		return CallVFunction<bool>(this, 14);
	}

	void RunCommand(C_BasePlayer* player, CUserCmd* ucmd, IMoveHelper* moveHelper)
	{
		return CallVFunction<void, C_BasePlayer*, CUserCmd*, IMoveHelper*>(this, 19, player, ucmd, moveHelper);
	}

	void SetupMove(C_BasePlayer* player, CUserCmd* ucmd, IMoveHelper* moveHelper, void* pMoveData)
	{
		return CallVFunction<void, C_BasePlayer*, CUserCmd*, IMoveHelper*, void*>(this, 20, player, ucmd, moveHelper, pMoveData);
	}

	void FinishMove(C_BasePlayer* player, CUserCmd* ucmd, void* pMoveData)
	{
		return CallVFunction<void, C_BasePlayer*, CUserCmd*, void*>(this, 21, player, ucmd, pMoveData);
	}

	//https://github.com/EternityX/DEADCELL-CSGO/blob/master/csgo/sdk/interfaces/i_prediction.h#L22
	void SetLocalViewangles(QAngle& angle) {
		CallVFunction<void, QAngle&>(this, 13, angle);
	}
